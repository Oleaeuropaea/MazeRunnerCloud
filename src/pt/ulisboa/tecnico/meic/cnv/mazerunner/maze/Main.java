...
public class Main {
	...
	public static void main(String[] args) throws InvalidMazeRunningStrategyException,
		...
		long int0 = System.nanoTime();
		System.out.print("read maze: ");
		System.out.print((int0 - start)/1e6);
		System.out.println("ms");
        // Solve the maze.
        strategy.solve(maze, xStart, yStart, xFinal, yFinal, velocity);
		long int1 = System.nanoTime();
		System.out.print("solve maze: ");
		System.out.print((int1 - int0)/1e9);
		...
		long int2 = System.nanoTime();
		System.out.print("print maze: ");
		System.out.print((int2 - int1)/1e6);
		System.out.println("ms");
	}
